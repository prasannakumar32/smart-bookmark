...
export function BookmarksComponent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      {/* Header */}
      <div className="bg-white backdrop-blur-lg border-b border-gray-200 sticky top-0 z-40">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        {/* User Info Card */}
        <div className="bg-white backdrop-blur-lg rounded-2xl border border-gray-200 p-6 mb-8 animate-fadeIn">
        ...
        {/* Add Bookmark Form */}
        <div className="bg-white backdrop-blur-lg rounded-2xl border border-gray-200 p-8 mb-8 animate-fadeIn">
        ...
        {/* Bookmarks List */}
        <div className="bg-white backdrop-blur-lg rounded-2xl border border-gray-200 p-8 animate-fadeIn min-h-[200px]">
          ...
          {bookmarks.length === 0 ? (
            <div className="text-center py-16 bg-gradient-to-br from-blue-50/50 to-transparent rounded-xl">
